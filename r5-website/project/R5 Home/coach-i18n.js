/* R5 — Coach page (Dmytro Pasichnyi) — bilingual content.
   ...
   Facts verified from the coach brief. No emoji. %G% = gym term (shared). */
window.R5_COACH = {
  uk: {
    hero: {
    ...
    quote: {
      text: "Сила, якої немає\nз тобою у шістдесят,\n— це не сила.",
      by: "Дмитро Пасічний",
      role: "Головний тренер R5",
    },
    ...
    dual: {
      ...
      local: {
        kicker: "У Дніпрі",
        title: "Приходь тренуватись",
        body: "Перше тренування безкоштовне, без зобовʼязань. Тренер підбере зручний час.",
        cta: "Записатись на безкоштовне",
      },
      online: {
        kicker: "Будь-де",
        title: "Тренуйся онлайн",
        body: "Його програмування та HRV-метод дистанційно. Індивідуальний план і контроль відновлення.",
  ...
  en: {
    ...
    dual: {
      ...
      local: {
        ...
        body: "Your first session is free, no strings. A coach will find a time that works for you.",
        cta: "Book a free session",
      },
      online: {
        kicker: "Anywhere",
        title: "Train online",
        body: "His programming and HRV method, remotely. An individual plan with recovery under control.",
