/* R5 — Online Coaching (remote) page — bilingual content.
   EN is primary in tone (the remote / diaspora wedge); UA is a full equal.
   Voice: plain, warm, earned, "ти/you". No emoji. Prices are PLACEHOLDERS in
   USD — the offering/format/price is TBD; final track confirmed on application.
   %G% = gym term (shared, swappable). Credibility stats reuse R5_I18N.proof. */
window.R5_ONLINE = {
  en: {
    hero: {
    ...
    cred: {
      eyebrow: "Why Dmytro",
      title: "A still-competing\nchampion's method",
      link: "Full coach story",
    },
      ...
      items: [
        {
          ...
          price: "$49",
          per: "/ month",
          items: ["Monthly programming", "Built around your equipment", "Email support"],
        },
        {
          name: "Online coaching",
          price: "$129",
          per: "/ month",
          items: ["Programming + the HRV method", "Recovery guidance", "Bi-weekly check-ins", "Direct message access"],
          popular: true,
        },
        {
          name: "1-to-1",
          price: "from $279",
          per: "/ month",
          items: ["Everything in coaching", "Weekly video calls", "A direct line to Dmytro", "Priority review"],
        },
      ],
    },
    ...
    apply: {
      ...
      name: "Name", email: "Email", goal: "Your goal",
      goalPh: "Get strong without breaking down",
  ...
  uk: {
      ...
      items: [
        {
          ...
          price: "$49",
          per: "/ місяць",
          items: ["Щомісячна програма", "Під твоє обладнання", "Підтримка поштою"],
        },
        {
          name: "Онлайн-коучинг",
          price: "$129",
          per: "/ місяць",
          items: ["Програма + HRV-метод", "Супровід відновлення", "Перевірки раз на два тижні", "Прямий звʼязок у месенджері"],
          popular: true,
        },
        {
          name: "Один на один",
          price: "від $279",
          per: "/ місяць",
          items: ["Усе з коучингу", "Щотижневі відеодзвінки", "Прямий контакт із Дмитром", "Пріоритетний перегляд"],
        },
      ],
    },
    ...
    apply: {
      ...
      name: "Імʼя", email: "Email", goal: "Твоя ціль",
      goalPh: "Стати сильним без травм",
      ...
      localText: "Ти в Дніпрі?",
      localLink: "Тренуйся в залі",
    },
  },
};
