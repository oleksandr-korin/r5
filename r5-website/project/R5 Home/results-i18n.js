/* R5 — Results & Community page — bilingual content.
   UA canonical · EN equal. Testimonials are shown in their original Ukrainian
   with an English rendering via the toggle; names stay consistent across both.
   Voice: plain, warm, earned, "ти". No emoji. Earned, not gamified — never
   infomercial. %G% = gym term (shared, swappable). PLACEHOLDER quotes/stories —
   request real member quotes, photos and consent from Dmytro before publishing. */
window.R5_RESULTS = {
  uk: {
    header: {
      ...
      items: [
        {
          ...
          from: "Ніколи не займалась спортом",
          to: "Перший local Open за плечима",
        ...
        },
        {
          ...
          from: "Біль у спині, втома",
          to: "Особисті рекорди в присіді й тязі",
        ...
        },
        {
          ...
          from: "Хронічний біль, кинув спорт",
          to: "Тренується без болю щотижня",
    ...
    board: {
      ...
      panel: {
        label: "COMMUNITY OPEN · 25.1",
        cap: "Останній тиждень",
        scheme: "AMRAP 15",
        rows: [
      ...
      items: [
        {
          ...
          from: "Never played a sport",
          to: "First local Open behind her",
        ...
        },
        {
          ...
          from: "Back pain, fatigue",
          to: "PRs in the squat and deadlift",
        ...
        },
        {
          ...
          from: "Chronic pain, quit sport",
          to: "Trains pain-free every week",
