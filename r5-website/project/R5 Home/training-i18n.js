/* R5 — Training & Programs page — bilingual content.
   UA canonical · EN equal. Voice: plain, warm, earned, "ти". No emoji.
   %G% = gym term (shared, swappable). Prices are placeholders in ₴ (UAH) —
   confirm with Dmytro. Beginner on-ramp leads (most hesitant first-timers). */
window.R5_TRAINING = {
  uk: {
    header: {
    ...
    programs: {
      ...
      items: [
        ...
        },
        {
          n: "02", tag: "Пн–Сб",
          t: "Групові класи",
          d: "Щоденний WOD під наглядом тренера. Кожен рух масштабується під твій рівень.",
        ...
        },
        {
          n: "03", tag: "1 на 1",
          t: "Персональні",
          d: "Один на один. Техніка, програма й прогрес, зібрані саме під тебе.",
    ...
    method: {
      eyebrow: "Метод R5",
      title: "Тренуємо важко —\nі програмуємо відновлення",
      body: "Дмитро — сертифікований HRV-тренер. Навантаження будується навколо відновлення нервової системи, щоб ти тренувався розумно й надовго, а не вигорав за сезон.",
      ...
      plans: [
        {
          ...
          price: "₴300",
          per: "/ заняття",
          items: ["Один візит", "Будь-який клас", "Без зобовʼязань"],
          cta: "Записатись",
        },
        {
          name: "Безлімітний місяць",
          price: "₴2 400",
          per: "/ місяць",
          items: ["Безліміт класів", "Відкритий зал включено", "Заморозка до 7 днів"],
          cta: "Обрати безліміт",
          popular: true,
        },
        {
          ...
          price: "від ₴700",
          per: "/ сесія",
          items: ["Один на один із тренером", "Індивідуальна програма", "Гнучкий графік"],
          cta: "Запитати деталі",
        },
      ],
    },
    ...
    online: {
      text: "Не в Дніпрі?",
      link: "Тренуйся з Дмитром онлайн",
    },
  },
  ...
  en: {
    ...
    programs: {
      ...
      items: [
        ...
        },
        {
          n: "02", tag: "Mon–Sat",
          t: "Group classes",
          d: "The daily WOD, coach-led. Every movement scales to your level.",
        ...
        },
        {
          n: "03", tag: "1-to-1",
          t: "Personal training",
          d: "One-on-one. Technique, programming and progress built around you.",
    ...
    method: {
      ...
      title: "Train hard —\nand program recovery",
      body: "Dmytro is a certified HRV coach. Load is built around nervous-system recovery, so you train smart and last for decades — instead of burning out in a season.",
      ...
      plans: [
        {
          ...
          price: "₴300",
          per: "/ session",
          items: ["One visit", "Any class", "No commitment"],
          cta: "Book a visit",
        },
        {
          ...
          price: "₴2,400",
          per: "/ month",
          items: ["Unlimited classes", "Open gym included", "Freeze up to 7 days"],
          cta: "Go unlimited",
          popular: true,
        },
        {
          ...
          price: "from ₴700",
          per: "/ session",
          items: ["One-on-one with a coach", "An individual program", "Flexible schedule"],
          cta: "Ask for details",
        },
      ],
    },
