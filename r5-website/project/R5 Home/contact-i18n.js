/* R5 — Start Here / Contact page — bilingual content.
   UA canonical · EN equal. Voice: warm, direct, friction-removing, "ти". No emoji.
   Single job: book a free first session, with low-friction alternatives.
   Instagram is real (@rokytnyi5.crossbox); phone / Telegram / email are
   PLACEHOLDERS — confirm with Dmytro. %G% = gym term (shared, swappable). */
window.R5_CONTACT = {
  uk: {
    header: {
      eyebrow: "Перший крок",
