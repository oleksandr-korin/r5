...
const RAW: Record<"uk" | "en", OnlineStrings> = {
  uk: {
    hero: {
      ...
      marked: "будь-де",
      sub: "Індивідуальне програмування та HRV-метод відновлення — з підтримкою на кожному кроці, де б ти не був. Метод, який Дмитро тестує на собі.",
    ...
    method: {
      ...
      cols: [
        { n: "01", t: "Тренуйся під себе",      d: "Персональна програма, що враховує твій рівень, обладнання й реальний тиждень." },
    ...
    cred: { eyebrow: "Чому Дмитро", title: "Метод, перевірений\nна собі", link: "Повна історія тренера" },
    how: {
  ...
  en: {
    hero: {
      ...
      marked: "anywhere",
      sub: "Individual programming and HRV-based recovery — with support at every step, wherever you are. The method Dmytro tests on himself.",
    ...
    method: {
      ...
      cols: [
        { n: "01", t: "Train around you",        d: "A personal program that respects your level, your equipment, and the week you actually have." },
    ...
    cred: { eyebrow: "Why Dmytro", title: "The method he\ntests on himself", link: "Full coach story" },
    how: {
